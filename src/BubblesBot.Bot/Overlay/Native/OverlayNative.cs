...
internal static partial class OverlayNative
{
    ...
    /// <summary>True iff the handle is still a top-level window owned by the attached PoE process.</summary>
    public static bool IsWindowForProcess(nint hwnd, int processId)
    {
